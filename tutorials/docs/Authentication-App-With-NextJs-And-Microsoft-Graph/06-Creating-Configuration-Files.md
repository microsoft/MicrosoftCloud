...
If you want to know more about the `middleware.ts` file, **[you can check the documentation of the next-auth](https://next-auth.js.org/configuration/nextjs#middleware)**.
